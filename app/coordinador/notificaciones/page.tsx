...
export default function NotificacionesCoordinador() {
  ...
  const getNotificationBadgeType = (notification: Notification) => {
    ...
    if (title.includes('asignada')) return 'asignacion';
  ...
  const filteredNotifications = notifications.filter(notification => {
    ...
    const categoryType = notification.category || getNotificationBadgeType(notification);
    const typeFilter = selectedType === "todos" || categoryType === selectedType;
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => handleTypeChange("asignacion")}>
                Asignaciones
              </DropdownMenuItem>
                      ...
                      <div className="flex-grow">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            <Badge
                              className={getBadgeStyle(getNotificationBadgeType(notification))}
                            >
                              {getNotificationBadgeType(notification)}
                            </Badge>
