...
export default function MisReservas() {
  ...
  const fetchReservations = async () => {
    ...
    try {
      ...
      const response = await fetch('https://deporsm-apiwith-1035693188565.us-central1.run.app/api/reservas/historial', {
        method: 'GET',
  ...
  const handleConfirmCancel = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://deporsm-apiwith-1035693188565.us-central1.run.app/api/reservas/${reservationToCancel}/cancelar?motivo=${encodeURIComponent(motivo)}`, {
        method: 'PUT',
